...
Contributions are welcome. `go-ruby-stringio/stringio` is built to a small set of non-negotiable
...
The library is in
[`github.com/go-ruby-stringio/stringio`](https://github.com/go-ruby-stringio/stringio). This documentation site is in
[`github.com/go-ruby-stringio/docs`](https://github.com/go-ruby-stringio/docs). Start from the
